...
<div class="form-group">
  ...
  <div class="form-group">
    <div class="col-lg-offset-2 col-lg-10">
      <button type="submit" class="btn btn-success" onClick ="valProblema($(&#34;#inputNombre&#34;).val(),$(&#34;#inputArea&#34;).val(), $(&#34;#inputFL&#34;).val(), $(&#34;#inputDetalle&#34;).val(),$(&#34;#inputTopico&#34;).val()); return false;">Agregar</button>
    </div>
