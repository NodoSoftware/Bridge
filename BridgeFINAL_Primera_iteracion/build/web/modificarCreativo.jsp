...
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="modificarCreativo.jsp">Mis datos</a></li>                      
    ...
    <div class="container">
        ...
        <p>
          <a class="btn btn-danger" onClick ="eliminarCreativo(<%= session.getAttribute( "idCreativo" ) %>)" >Eliminar Creativo</a> <a class="btn btn-primary" onClick ="$('#borrar').hide()">Nah mejor no</a>
        </p>
      </div>
                <form class="form-horizontal" role="form" method="POST">
                    ...
                    <div class="form-group">                                        
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="carrera" placeholder = "Ej. Microsoft">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="telefonoC" placeholder = "Ej. 2918 1092">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="text" class="form-control" id="fechaC">
                        </div>
                    </div>

                    <div class="form-group">
     <script>         
      cargarDetallesCreativo(<%= session.getAttribute( "idCreativo" ) %>);      
</script>
  </div>
                    <div class="form-group">
                        <div class="col-lg-offset-2 col-lg-10">
                            <button type="submit" class="btn btn-success" onClick ="valCreativoUpdate($(&#34;#nombreP&#34;).val(), $(&#34;#carrera&#34;).val(), $(&#34;#correoP&#34;).val(), $(&#34;#telefonoC&#34;).val(),  $(&#34;#fechaC&#34;).val(), <%= session.getAttribute("idCreativo")%>); return false;">Actualizar</button>
    ...
    <script>
           $(window).load(function() {
               $("#fechaC").datepicker({dateFormat: 'yy-mm-dd'});
           });
    </script>
</body>
</html>
