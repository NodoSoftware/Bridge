...
public class ProblemaBD {
    ...
    public List<Problema> getListaProblemasCreativo(){
        ...
        try {
         ...
         // Instrucci�n SQL para obtener los datos
         // del usuario indicado :
         String query = "SELECT titulo,descripcion,idProblema FROM problema";
         Statement st = con.createStatement();
         ResultSet rs = st.executeQuery( query );
         while(rs.next()){
             String titulo = rs.getString("titulo");
    ...
    public boolean setAporte(Integer idp, Integer ida){
        ...
        try {
         ...
         // Instrucci�n SQL para obtener los datos
         // del usuario indicado :
         String query = "UPDATE problema SET idAporteFinalFK = '"+ida+"' WHERE idProblema = "+idp;
         Statement st = con.createStatement();
         int rs = st.executeUpdate( query );
         estado = true;
         cn.cierraConexion( con );
