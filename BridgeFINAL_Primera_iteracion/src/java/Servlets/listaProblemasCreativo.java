...
public class listaProblemasCreativo extends HttpServlet {
ProblemaBD problema;
    
    public listaProblemasCreativo(){
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           Problemas = problema.getListaProblemasCreativo();
            ListIterator<Problema> listaProblemasC = Problemas.listIterator();
      
           while(listaProblemasC.hasNext()){
               Problema p = listaProblemasC.next();
