 ...
 */
public class listaAportes extends HttpServlet {
AporteBD aporte;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
           ...
           String idP = request.getParameter("idProblema");
           Aportes = aporte.getListaAportes(Integer.parseInt(idP));
           ListIterator<Aporte> listaProblemas = Aportes.listIterator();
            
      
    
           while(listaProblemas.hasNext()){
               Aporte a = listaProblemas.next();
